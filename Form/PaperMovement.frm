...
Begin VB.Form FrmPaperMovement 
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "PaperMovement.frx":0000
      Begin TabDlg.SSTab SSTab1 
         ...
         EndProperty
         TabCaption(0)   =   "&List"
         TabPicture(0)   =   "PaperMovement.frx":001C
         ...
         TabPicture(1)   =   "PaperMovement.frx":0038
         ...
         Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame2 
            ...
            FormatString    =   ""
            Caption         =   ""
            Picture         =   "PaperMovement.frx":0054
            ...
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel19 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":0070
               Picture         =   "PaperMovement.frx":008C
            End
            ...
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel5 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":00A8
               Picture         =   "PaperMovement.frx":00C4
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":00E0
               Picture         =   "PaperMovement.frx":00FC
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel4 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":0118
               Picture         =   "PaperMovement.frx":0134
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel3 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":0150
               Picture         =   "PaperMovement.frx":016C
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel11 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":0188
               Picture         =   "PaperMovement.frx":01A4
            End
            ...
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel12 
               ...
               FillColor       =   8421376
               TextColor       =   16777215
               Picture         =   "PaperMovement.frx":01C0
               Picture         =   "PaperMovement.frx":01DC
            End
...
Option Explicit
Public AML As String 'A-Add L-List
...
Private Sub Form_Load()
    ...
    CxnPaperMovement.Open cnDatabase.ConnectionString
    ...
    rstPaperList.Open "SELECT LTRIM(P.Name) As Col0,C.Name As UOM,C.Value1 As SPU,[Units/Bundle],P.Code FROM PaperMaster P INNER JOIN GeneralMaster C ON P.UOM=C.Code ORDER BY P.Name", CxnPaperMovement, adOpenKeyset, adLockReadOnly
    rstAccountList.Open "SELECT LTRIM(Name) As Col0,Code FROM AccountMaster ORDER BY Name", CxnPaperMovement, adOpenKeyset, adLockReadOnly
    rstPaperMVList.Open "SELECT T.Code,T.Name, Date, M1.Name As GodownFromName,M2.Name As GodownToName FROM (PaperMVParent T INNER JOIN AccountMaster M1 ON T.AccountFrom=M1.Code) INNER JOIN AccountMaster M2 ON T.AccountTo=M2.Code ORDER BY T.Name", CxnPaperMovement, adOpenKeyset, adLockOptimistic
    ...
    If rstPaperMVList.RecordCount > 0 Then
        ...
        Else
            ...
            rstPaperMVList.Find "[Code]='" & VchCode & "'"
        End If
    End If
...
Private Sub Form_Activate()
    ...
    If MdiMainMenu.mnuPaperMovementVch.Enabled Then AddModifyList
    MdiMainMenu.mnuPaperMovementVch.Enabled = False
End Sub
...
Private Sub Form_KeyDown(KeyCode As Integer, Shift As Integer)
    If Shift = 0 And KeyCode = vbKeyEscape Then
        ...
        Else
            ...
            If Not Me.ActiveControl Is Nothing Then
                If Me.ActiveControl.Name <> "Text5" And Me.ActiveControl.Name <> "MhRealInput1" And Me.ActiveControl.Name <> "MhRealInput4" Then KeyCode = 0
    ...
    ElseIf Shift = vbCtrlMask And KeyCode = vbKeyS And Toolbar1.Buttons.Item(4).Enabled Then
        If Me.ActiveControl.Name <> "Text5" And Me.ActiveControl.Name <> "MhRealInput1" And Me.ActiveControl.Name <> "MhRealInput4" Then Toolbar1_ButtonClick Toolbar1.Buttons.Item(4)
        KeyCode = 0
    ...
    ElseIf Shift = 0 And KeyCode = vbKeyReturn Then
        If Toolbar1.Buttons.Item(1).Enabled Then
            ...
            SSTab1.SetFocus
        Else
            If Me.ActiveControl.Name <> "MhRealInput4" Then SendKeys "{TAB}"
        End If
        If Me.ActiveControl.Name <> "MhRealInput4" Then KeyCode = 0
    End If
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    DisableChildMenu
    MdiMainMenu.mnuPaperMovementVch.Enabled = True
End Sub
...
Public Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 1 Then
        ...
        If AddRecord(rstPaperMVParent) Then
            Text2.Text = GenerateCode(CxnPaperMovement, "SELECT MAX(" & IIf(DatabaseType = "MS SQL", "CONVERT(INT,Name))", "VAL(Name))") & "  FROM PaperMVParent", 10, Space(1))
    ...
    ElseIf Button.Index = 5 Then
        If CancelRecordUpdate(rstPaperMVParent) Then
            ...
            If rstPaperMVParent.State = adStateOpen Then rstPaperMVParent.Close
            rstPaperMVParent.CursorLocation = adUseClient
            Call SetButtons(True)
            SetButtonsForNoRecord
            If AML = "A" Then
...
Private Sub Text2_Validate(Cancel As Boolean)
    ...
    If CheckEmpty(Text2, True) Then
        Cancel = True
'    ElseIf CheckDuplicate(CxnPaperMovement, "PaperMVParent", "Code", "[Name]", Trim(Text2.Text), rstPaperMVParent.Fields("Code").Value, False) Then
'        Cancel = True
    End If
End Sub
...
Private Sub ViewRecord()
    ...
    ClearFields ("C")
    If rstPaperMVList.EOF Then
        If rstPaperMVChild.State = adStateOpen Then rstPaperMVChild.Close
        Exit Sub
    End If
    FindRecord
    LoadFields
...
Private Sub LoadFields()
    ...
    If Not rstAccountList.EOF Then Text9.Text = rstAccountList.Fields("Col0").Value
    Text4.Text = rstPaperMVParent.Fields("Remarks").Value
    Call LoadPaperList(rstPaperMVParent.Fields("Code").Value)
    If rstPaperMVChild.State = adStateOpen Then CalculateTotal
End Sub
Private Sub EditRecord()
    On Error GoTo ErrorHandler
    If rstPaperMVParent.RecordCount = 0 Then Exit Sub
    If rstPaperMVChild.State = adStateClosed Then SSTab1.Tab = 0: Exit Sub
    If rstPaperMVParent.State = adStateOpen Then rstPaperMVParent.Close
...
Private Sub LoadPaperList(ByVal strVoucherCode As String)
    On Error GoTo ErrorHandler
    If rstPaperMVChild.State = adStateOpen Then rstPaperMVChild.Close
    rstPaperMVChild.Open "SELECT Paper,M1.Name As PaperName,M2.Name As UOM,M2.Value1 As SPU,QuantityOther,Tat FROM (PaperMVChild T INNER JOIN PaperMaster M1 ON T.Paper=M1.Code) INNER JOIN GeneralMaster M2 ON M1.UOM=M2.Code WHERE T.Code = '" & strVoucherCode & "' ORDER BY M1.Name", CxnPaperMovement, adOpenKeyset, adLockOptimistic
...
Private Sub DataGrid2_KeyDown(KeyCode As Integer, Shift As Integer)
    If Shift = vbCtrlMask And KeyCode = vbKeyE Then
        If rstPaperMVChild.RecordCount = 0 Then KeyCode = 0: Exit Sub
...
Private Sub rstPaperMVChild_MoveComplete(ByVal adReason As ADODB.EventReasonEnum, ByVal pError As ADODB.Error, adStatus As ADODB.EventStatusEnum, ByVal pRecordset As ADODB.Recordset)
    ...
    If Not (rstPaperMVChild.EOF Or rstPaperMVChild.BOF) Then
        If Not IsNull(rstPaperMVChild.Fields("UOM").Value) Then Text6.Text = rstPaperMVChild.Fields("UOM").Value
    End If
End Sub
...
Private Sub Text5_KeyDown(KeyCode As Integer, Shift As Integer)
    If Shift = 0 And KeyCode = vbKeyEscape Then MakeTextBoxInvisible (True)
End Sub
Private Sub Text5_Validate(Cancel As Boolean)
    ...
    If rstPaperList.EOF Then
        ...
        If CheckEmpty(Text5.Text, False) Then
            Text5.Text = "?"
        End If
        If RTrim(PaperCode) <> "" Then SendKeys "{TAB}"
        Cancel = True
        Exit Sub
    ...
    Text6.Text = rstPaperList.Fields("UOM").Value
    BalanceQuantity = CalculatePaperBalance(AccountFromCode, PaperCode, CheckNull(rstPaperMVParent.Fields("Code").Value), "PMV")
    SPU = Val(rstPaperList.Fields("SPU").Value)
    MsgBox "Quantity at Godown : " & Format(Str(Int(BalanceQuantity / SPU) + ((BalanceQuantity Mod SPU) / 1000)), "#0.000")
End Sub
...
Private Sub MhRealInput1_KeyDown(KeyCode As Integer, Shift As Integer)
    ...
    If Shift = 0 And KeyCode = vbKeyReturn Then
        ...
        Quantity = (Int(Val(MhRealInput1.Text)) * SPU) + ((Val(MhRealInput1.Text) - Int(Val(MhRealInput1.Text))) * 1000)
        If Val(MhRealInput1.Text) <= 0 Or Quantity > BalanceQuantity Then
            If Val(MhRealInput1.Text) > 0 Then
                Call DisplayError("Quantity cann't be greater than " & Format(Str(Int(BalanceQuantity / SPU) + ((BalanceQuantity Mod SPU) / 1000)), "#0.000"))
            End If
        ...
        Else
            ...
            rstPaperMVChild.Fields("UOM").Value = Trim(Text6.Text)
            rstPaperMVChild.Fields("QuantityOther").Value = Format(Val(MhRealInput1.Text), "0.000")
            rstPaperMVChild.Fields("SPU").Value = SPU
...
Private Sub MhRealInput1_Validate(Cancel As Boolean)
    ...
    Else
        ...
        If Val(MhRealInput1.Text) <= 0 Or Quantity > BalanceQuantity Then
            ...
            FocusSelect Me.ActiveControl
        Else
            RPB = Val(rstPaperList.Fields("Units/Bundle").Value)
            If RPB <> 0 Then MhRealInput4.Text = Format(Int(Val(MhRealInput1.Text) / RPB), "0")
        End If
    End If
End Sub
...
Private Function CheckDuplicatePaper() As Boolean
    ...
    If Not (rstPaperMVChild.EOF Or rstPaperMVChild.BOF) Then dblBookMark = rstPaperMVChild.Bookmark
    rstPaperMVChild.MoveFirst
    Do While Not rstPaperMVChild.EOF
          If rstPaperMVChild.Fields("PaperName").Value = Trim(Text5.Text) Then CheckDuplicatePaper = True: Exit Do
          rstPaperMVChild.MoveNext
    Loop
    If dblBookMark <> 0 Then rstPaperMVChild.Bookmark = dblBookMark Else rstPaperMVChild.MoveLast
End Function
Private Function UpdatePaperList(ByVal strOption As String) As Boolean
    ...
    Else
        Sheets = (Int(Val(rstPaperMVChild.Fields("QuantityOther").Value)) * Val(rstPaperMVChild.Fields("SPU").Value)) + ((Val(rstPaperMVChild.Fields("QuantityOther").Value) - Int(Val(rstPaperMVChild.Fields("QuantityOther").Value))) * 1000)
...
Private Sub PrintPaperMovement()
    ...
    rptPaperMovement.Text1.SetText "Paper Movement Voucher"
    ...
    End If
    If rstPaperMVChild.State = adStateOpen Then rstPaperMVChild.Close
    rstPaperMVChild.Open "SELECT TRIM(P.Name) As VchNo,[Date] As VchDate,M2.PrintName As GodownFrom,M2.Address1 As GodownFromAddress1,M2.Address2 As GodownFromAddress2,M2.Address3 As GodownFromAddress3,M2.Address4 As GodownFromAddress4,M3.PrintName As GodownTo,M3.Address1 As GodownToAddress1,M3.Address2 As GodownToAddress2,M3.Address3 As GodownToAddress3,M3.Address4 As GodownToAddress4,TRIM(M1.PrintName)+' (UOM : '+TRIM(U.PrintName)+'='+TRIM(U.Value1)+')' As PaperName,QuantityOther As Quantity,Remarks FROM ((((PaperMVParent P LEFT JOIN PaperMVChild C ON P.Code=C.Code) LEFT JOIN PaperMaster M1 ON C.Paper=M1.Code) LEFT JOIN AccountMaster M2 ON P.AccountFrom=M2.Code) LEFT JOIN AccountMaster M3 ON P.AccountTo=M3.Code) LEFT JOIN GeneralMaster U ON M1.UOM=U.Code AND P.Code='" & rstPaperMVList.Fields("Code").Value & "' ORDER BY M1.Name", CxnPaperMovement, adOpenKeyset, adLockOptimistic
