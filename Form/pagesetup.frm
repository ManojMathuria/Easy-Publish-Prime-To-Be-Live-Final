...
Private Sub Command2_Click(Index As Integer)
    ...
    If Index = 0 Then
        ...
        'Update margins
        frmPageSetup.fpSpread1.PrintMarginTop = CDbl(pagemargin(2).Text) * 1440
        frmPageSetup.fpSpread1.PrintMarginBottom = CDbl(pagemargin(3).Text) * 1440
        frmPageSetup.fpSpread1.PrintMarginLeft = CDbl(pagemargin(0).Text) * 1440
        ...
        'Landscape
        Else
            frmPageSetup.fpSpread1.PrintOrientation = PrintOrientationLandscape
        End If
...
Private Sub Form_Load()
    ...
    pagemargin(0).Text = Format(frmPageSetup.fpSpread1.PrintMarginLeft / 1440, "0.00")
    pagemargin(1).Text = Format(frmPageSetup.fpSpread1.PrintMarginRight / 1440, "0.00")
    pagemargin(2).Text = Format(frmPageSetup.fpSpread1.PrintMarginTop / 1440, "0.00")
    pagemargin(3).Text = Format(frmPageSetup.fpSpread1.PrintMarginBottom / 1440, "0.00")
    
    'Get page orientation
    If frmPageSetup.fpSpread1.PrintOrientation = PrintOrientationLandscape Then
        porientation(1) = True
    Else
        porientation(0) = True
    End If
