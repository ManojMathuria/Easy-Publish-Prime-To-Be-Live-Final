...
Begin VB.Form FrmPaperDebitNote 
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "PaperDebitNote.frx":0000
      Begin TabDlg.SSTab SSTab1 
         ...
         EndProperty
         TabCaption(0)   =   "&List"
         TabPicture(0)   =   "PaperDebitNote.frx":001C
         ...
         TabPicture(1)   =   "PaperDebitNote.frx":0038
         ...
         Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame2 
            ...
            FormatString    =   ""
            Caption         =   ""
            Picture         =   "PaperDebitNote.frx":0054
            ...
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel5 
               ...
               FillColor       =   9164542
               TextColor       =   0
               Picture         =   "PaperDebitNote.frx":0070
               Picture         =   "PaperDebitNote.frx":008C
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
               ...
               FillColor       =   9164542
               TextColor       =   0
               Picture         =   "PaperDebitNote.frx":00A8
               Picture         =   "PaperDebitNote.frx":00C4
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel3 
               ...
               FillColor       =   9164542
               TextColor       =   0
               Picture         =   "PaperDebitNote.frx":00E0
               Picture         =   "PaperDebitNote.frx":00FC
            End
            Begin Mh3dlblLib.Mh3dLabel Mh3dLabel11 
               ...
               FillColor       =   9164542
               TextColor       =   0
               Picture         =   "PaperDebitNote.frx":0118
               Picture         =   "PaperDebitNote.frx":0134
            End
            Begin TDBDate6Ctl.TDBDate MhDateInput1 
               ...
               _ExtentX        =   1931
               _ExtentY        =   582
               Calendar        =   "PaperDebitNote.frx":0150
               Caption         =   "PaperDebitNote.frx":0268
               BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
                  Name            =   "Calibri"
                  Size            =   9.75
                  Charset         =   0
                  ...
                  Strikethrough   =   0   'False
               EndProperty
               DropDown        =   "PaperDebitNote.frx":02D4
               Keys            =   "PaperDebitNote.frx":02F2
               Spin            =   "PaperDebitNote.frx":0350
               AlignHorizontal =   0
               AlignVertical   =   0
               Appearance      =   0
               BackColor       =   16777215
            ...
            Begin FPSpreadADO.fpSpread fpSpread1 
               ...
               MaxCols         =   8
               MaxRows         =   1000
               SpreadDesigner  =   "PaperDebitNote.frx":0378
            End
            Begin VB.Line Line1 
               X1              =   0
               X2              =   13305
...
Dim AccountCode As String, PaperCode As Variant
...
Private Sub Form_Load()
    ...
    Me.Caption = "Paper " & IIf(VchType = "D", "Debit", "Credit") & " Note"
    cnxPaperDebitNote.CursorLocation = adUseClient
    If cnxPaperDebitNote.State = adStateOpen Then cnxPaperDebitNote.Close
    cnxPaperDebitNote.Open cnDatabase.ConnectionString
    rstPaperDNList.Open "SELECT T.Code,T.Name,T.Date,M.Name As AccountName,Amount FROM PaperDNParent T INNER JOIN AccountMaster M ON T.Account=M.Code WHERE VchType='" & VchType & "' AND FYCode='" & FYCode & "' ORDER BY T.Name", cnxPaperDebitNote, adOpenKeyset, adLockOptimistic
...
Private Sub Form_Activate()
    ...
    MdiMainMenu.mnuPaperModule(5).Enabled = False: MdiMainMenu.mnuPaperModule(6).Enabled = False
End Sub
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    DisableChildMenu
    MdiMainMenu.mnuPaperModule(5).Enabled = True: MdiMainMenu.mnuPaperModule(6).Enabled = True
End Sub
...
Public Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 1 Then
        ...
        If AddRecord(rstPaperDNParent) Then
            Text2.Text = GenerateCode(cnxPaperDebitNote, "SELECT MAX(" & IIf(DatabaseType = "MS SQL", "CONVERT(INT,Name))", "VAL(Name))") & "  FROM PaperDNParent WHERE VchType='" & VchType & "' AND FYCode='" & FYCode & "'", 10, Space(1))
...
Private Sub DataGrid1_HeadClick(ByVal ColIndex As Integer)
    ...
    If AD = "Asc" Then
        rstPaperDNList.Sort = "[" + SortOrder & "] Desc"
        AD = "Desc"
    Else
...
Private Sub Text2_Validate(Cancel As Boolean)
    ...
    If CheckEmpty(Text2, True) Then
        Cancel = True
    ElseIf CheckDuplicate(cnxPaperDebitNote, "PaperDNParent", "Code", "[Name]+VchType", Trim(Text2.Text) & VchType, rstPaperDNParent.Fields("Code").Value, False, FYCode) Then
        Cancel = True
    End If
End Sub
...
Private Sub SaveFields()
    ...
    rstPaperDNParent.Fields("VchType").Value = VchType
    rstPaperDNParent.Fields("FYCode").Value = FYCode
    ...
    ElseIf KeyCode = vbKeySpace Then
        With fpSpread1
            If .ActiveCol = 1 Then
                ...
                .SetText 7, .ActiveRow, slCode
                If Not CheckEmpty(slCode, False) Then
                    LoadMasterList
                    rstPaperList.MoveFirst: rstPaperList.Find "[Code] ='" & slCode & "'"
                    .SetText 3, .ActiveRow, Val(rstPaperList.Fields("Weight/Unit").Value)
                    .SetText 8, .ActiveRow, Val(rstPaperList.Fields("SPU").Value)
                    Sendkeys "{ENTER}"
                Else
...
Private Sub fpSpread1_LeaveCell(ByVal Col As Long, ByVal Row As Long, ByVal NewCol As Long, ByVal NewRow As Long, Cancel As Boolean)
    Dim Qty As Variant, Rate As Variant, Wt As Variant, Paper As Variant, GrWt As Double, SPU As Variant
    With fpSpread1
        If Col = 1 Or Col = 2 Or Col = 5 Then
            ...
            .GetText 8, Row, SPU
            GrWt = Fix(Qty) * Wt
            If Qty - Fix(Qty) > 0 Then GrWt = GrWt + ((Qty - Fix(Qty)) * 1000) * (Wt / Val(SPU))
...
Private Sub LoadPaperList(ByVal DNCode As String)
    ...
    On Error GoTo ErrorHandler
    If rstPaperDNChild.State = adStateOpen Then rstPaperDNChild.Close
    rstPaperDNChild.Open "SELECT Paper,LTRIM(M1.Name)+' (UOM : '+LTRIM(M2.Name)+')' As PaperName,Quantity,M1.[Weight/Unit],Weight,Rate,Amount,M2.Value1 As SPU FROM (PaperDNChild T INNER JOIN PaperMaster M1 ON T.Paper=M1.Code ) INNER JOIN GeneralMaster M2 ON M1.UOM=M2.Code WHERE T.Code='" & DNCode & "' ORDER BY M1.Name", cnxPaperDebitNote, adOpenKeyset, adLockOptimistic
    ...
    Do While Not rstPaperDNChild.EOF
        ...
        With fpSpread1
            ...
            .SetText 2, i, Abs(Val(rstPaperDNChild.Fields("Quantity").Value))
            .SetText 3, i, Val(rstPaperDNChild.Fields("Weight/Unit").Value)
            ...
            .SetText 8, i, Val(rstPaperDNChild.Fields("SPU").Value)
        End With
...
Private Function UpdatePaperList(ByVal ActionType As String) As Boolean
    ...
    Else
        ...
        End With
        cnxPaperDebitNote.Execute "INSERT INTO PaperDNChild VALUES ('" & rstPaperDNParent.Fields("Code").Value & "','" & CellVal(5) & "'," & IIf(VchType = "D", 0 - Val(CellVal(1)), Val(CellVal(1))) & "," & Val(CellVal(2)) & "," & Val(CellVal(3)) & "," & Val(CellVal(4)) & ")"
    End If
    Exit Function
ErrorHandler:
...
Private Sub PrintPaperDebitNote(ByVal VchNo As String, ByVal OutputTo As String)
    ...
    rptPaperDebitNote.Text28.SetText "Total Amount " & IIf(VchType = "D", "Debited", "Credited") & " due to " & Chr(34) & "PAPER A/C ADJUSTMENT" + Chr(34)
    ...
    ElseIf OutputTo = "P" Then
        rptPaperDebitNote.PaperSource = crPRBinAuto
...
Private Sub LoadMasterList()
    ...
    rstAccountList.Open "SELECT LTRIM(Name) As Col0,Code FROM AccountMaster ORDER BY Name", cnxPaperDebitNote, adOpenKeyset, adLockReadOnly
    If rstPaperList.State = adStateOpen Then rstPaperList.Close
    rstPaperList.Open "SELECT LTRIM(M1.Name)+' (UOM : '+LTRIM(M2.Name)+')' As Col0,[Weight/Unit],M2.Value1 As SPU,M1.Code FROM PaperMaster M1 INNER JOIN GeneralMaster M2 ON M1.UOM=M2.Code ORDER BY M1.Name", cnxPaperDebitNote, adOpenKeyset, adLockReadOnly
