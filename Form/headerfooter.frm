...
Option Explicit
Public frmHeaderFooter As Form
...
Dim headerstring As String
    ...
    If Option3(0).Value = True Then
        frmHeaderFooter.fpSpread1.PrintHeader = headerstring
    'Footer string
    Else
        frmHeaderFooter.fpSpread1.PrintFooter = headerstring
    End If
...
Dim choice As Integer
    ...
    If choice = 6 Then  'Yes
        If Option3(0).Value = True Then
            frmHeaderFooter.fpSpread1.PrintHeader = ""
            'Reset the display
            GetHeaderDetail frmHeaderFooter.fpSpread1.PrintHeader
        Else
            frmHeaderFooter.fpSpread1.PrintFooter = ""
            'Reset the display
            GetHeaderDetail frmHeaderFooter.fpSpread1.PrintFooter
        End If
    End If
