...
Begin VB.Form FrmChangePassword 
   ...
   Begin VB.CommandButton cmdCancel 
      ...
      Height          =   375
      Left            =   3720
      Picture         =   "ChangePassword.frx":047C
      Style           =   1  'Graphical
      TabIndex        =   7
      ToolTipText     =   "Cancel"
      Top             =   480
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "ChangePassword.frx":057E
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ChangePassword.frx":059A
         Picture         =   "ChangePassword.frx":05B6
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ChangePassword.frx":05D2
         Picture         =   "ChangePassword.frx":05EE
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel3 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "ChangePassword.frx":060A
         Picture         =   "ChangePassword.frx":0626
      End
   End
...
Private Sub cmdChange_Click()
    ...
    On Error GoTo ErrorHandler
    If rstUserMaster.State = adStateClosed Then rstUserMaster.Open "Select * From UserMaster Where Name = '" & FixQuote(User) & "'", cnDatabase, adOpenKeyset, adLockPessimistic
    rstUserMaster.Fields("Printstatus").Value = "N"
    cmdChange.Picture = LoadPicture(App.Path & "\Icon\Yellow.Bmp")
    If UCase(oEncrypt.DecryptString(Trim(rstUserMaster.Fields("Password")))) = UCase(Trim(txtOldPassword.Text)) Then IsOldPasswordOk = True
    If UCase(Trim(txtNewPassword.Text)) = UCase(Trim(txtConfirmPassword.Text)) Then IsNewPasswordOk = True
