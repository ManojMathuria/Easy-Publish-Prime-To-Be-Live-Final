...
Begin VB.Form FrmPaperPOPrintUtility 
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "PaperPOPrintUtility.frx":0000
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "PaperPOPrintUtility.frx":001C
         Picture         =   "PaperPOPrintUtility.frx":0038
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "PaperPOPrintUtility.frx":0054
         Picture         =   "PaperPOPrintUtility.frx":0070
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel4 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "PaperPOPrintUtility.frx":008C
         Picture         =   "PaperPOPrintUtility.frx":00A8
      End
      Begin VB.Line Line1 
         X1              =   0
         X2              =   3750
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PaperPOPrintUtility.frx":00C4
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PaperPOPrintUtility.frx":01D8
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PaperPOPrintUtility.frx":02EA
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub PrintPaperPurchaseOrder(ByVal OutputType As String)
    ...
    If ListView1.ListItems(1).Checked Then
        ...
        rstPaperPurchaseOrder.Open "SELECT Code FROM PaperPOParent WHERE OrderType='1' AND Name >= '" & Pad(Trim(MhRealInput15.Text), Space(1), 10, "L") & "' AND Name <= '" & Pad(Trim(MhRealInput16.Text), Space(1), 10, "L") & "' ORDER BY Name", cnDatabase, adOpenKeyset, adLockReadOnly
        Screen.MousePointer = vbNormal
        If rstPaperPurchaseOrder.RecordCount = 0 Then On Error GoTo 0: Exit Sub
        Do While Not rstPaperPurchaseOrder.EOF
            Call FrmPaperPurchaseOrder.PrintPaperPurchaseOrder(rstPaperPurchaseOrder.Fields("Code").Value, txtRemarks.Text, OutputType)
            rstPaperPurchaseOrder.MoveNext
        Loop
    End If
    If ListView1.ListItems(2).Checked Then
        If rstPaperPurchaseOrder.State = adStateOpen Then rstPaperPurchaseOrder.Close
        rstPaperPurchaseOrder.Open "SELECT Code FROM PaperPOParent WHERE OrderType='2' AND Name >= '" & Pad(Trim(MhRealInput15.Text), Space(1), 10, "L") & "' AND Name <= '" & Pad(Trim(MhRealInput16.Text), Space(1), 10, "L") & "' ORDER BY Name", cnDatabase, adOpenKeyset, adLockReadOnly
        Screen.MousePointer = vbNormal
        If rstPaperPurchaseOrder.RecordCount = 0 Then On Error GoTo 0: Exit Sub
        Do While Not rstPaperPurchaseOrder.EOF
            Call FrmPaperPurchaseOrder.PrintPaperPurchaseOrder(rstPaperPurchaseOrder.Fields("Code").Value, txtRemarks.Text, OutputType)
