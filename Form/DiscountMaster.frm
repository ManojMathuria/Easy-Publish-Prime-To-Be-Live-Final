...
Begin VB.Form FrmDiscountMaster 
   ...
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame2 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "DiscountMaster.frx":0000
      Begin VB.CommandButton cmdExit 
         Height          =   375
         Left            =   7725
         Picture         =   "DiscountMaster.frx":001C
         Style           =   1  'Graphical
         TabIndex        =   7
         TabStop         =   0   'False
         ToolTipText     =   "Exit"
      ...
      Begin VB.CommandButton cmdRefresh 
         Height          =   375
         Left            =   7370
         Picture         =   "DiscountMaster.frx":011E
         Style           =   1  'Graphical
         TabIndex        =   4
         TabStop         =   0   'False
         ToolTipText     =   "Refresh"
      ...
      Begin VB.CommandButton cmdDelete 
         Height          =   375
         Left            =   7010
         Picture         =   "DiscountMaster.frx":0268
         Style           =   1  'Graphical
         TabIndex        =   3
         TabStop         =   0   'False
         ToolTipText     =   "Delete"
      ...
      Begin VB.CommandButton cmdSave 
         Height          =   375
         Left            =   6650
         Picture         =   "DiscountMaster.frx":036A
         Style           =   1  'Graphical
         TabIndex        =   2
         TabStop         =   0   'False
         ToolTipText     =   "Save"
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "DiscountMaster.frx":046C
         Picture         =   "DiscountMaster.frx":0488
      End
      Begin FPSpreadADO.fpSpread fpSpread1 
         ...
         MaxRows         =   1000
         ScrollBars      =   2
         SpreadDesigner  =   "DiscountMaster.frx":04A4
      End
...
Dim cnDiscountMaster As New ADODB.Connection, rstDiscountList As New ADODB.Recordset
Dim PartyCode As String, EditMode As Boolean
Private Sub Form_Load()
    On Error GoTo ErrorHandler
    CenterForm Me
    BusySystemIndicator True
    DisableCloseButton Me
    cnDiscountMaster.CursorLocation = adUseClient: cnDiscountMaster.Open cnDatabase.ConnectionString
...
Private Sub Form_Unload(Cancel As Integer)
    Call CloseRecordset(rstDiscountList)
    Call CloseConnection(cnDiscountMaster)
End Sub
Private Sub Text2_KeyDown(KeyCode As Integer, Shift As Integer)
    If KeyCode = vbKeySpace Then
        ...
        End With
        On Error GoTo 0
        PartyCode = slCode: Text2.Text = slName
        If Not CheckEmpty(PartyCode, False) Then Sendkeys "{TAB}"
    End If
End Sub
Private Sub Text2_Validate(Cancel As Boolean)
    ...
    On Error GoTo ErrorHandler
    Dim i As Integer
    With rstDiscountList
        If .State = adStateOpen Then .Close
        .Open "SELECT ItemGroup As ItemGroupId,G.Name As ItemGroup,[Disc%] FROM DiscountMaster D INNER JOIN GeneralMaster G ON D.ItemGroup=G.Code WHERE D.Party='" & PartyCode & "' AND FYCode='" & FYCode & "' ORDER BY G.Name", cnDatabase, adOpenKeyset, adLockReadOnly
        ...
        Do Until .EOF
            i = i + 1
            fpSpread1.SetText 1, i, .Fields("ItemGroup").Value
            fpSpread1.SetText 2, i, Val(.Fields("Disc%").Value)
            fpSpread1.SetText 3, i, .Fields("ItemGroupId").Value
            .MoveNext
        Loop
    End With
    fpSpread1.SetActiveCell 1, 1
...
Private Sub cmdSave_Click()
    ...
    cnDiscountMaster.BeginTrans
    cnDiscountMaster.Execute "DELETE FROM DiscountMaster WHERE Party='" & PartyCode & "' AND FYCode='" & FYCode & "'"
    With fpSpread1
        For i = 1 To .DataRowCnt
            .GetText 2, i, CellVal(1) 'Disc %
            .GetText 3, i, CellVal(2) 'Item Group
            cnDiscountMaster.Execute "INSERT INTO DiscountMaster VALUES ('" & PartyCode & "','" & CellVal(2) & "'," & Val(CellVal(1)) & ",'" & FYCode & "')"
        Next
    End With
    MdiMainMenu.MousePointer = vbNormal
    cnDiscountMaster.CommitTrans
...
ErrorHandler:
    MdiMainMenu.MousePointer = vbNormal
    DisplayError (Err.Description)
    cnDiscountMaster.RollbackTrans
End Sub
