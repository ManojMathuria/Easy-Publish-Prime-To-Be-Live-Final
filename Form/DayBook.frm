...
Begin VB.Form FrmDayBook 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DayBook.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DayBook.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "DayBook.frx":0658
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "DayBook.frx":0788
         Picture         =   "DayBook.frx":07A4
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "DayBook.frx":07C0
         Picture         =   "DayBook.frx":07DC
      End
      Begin TDBDate6Ctl.TDBDate MhDateInput1 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "DayBook.frx":07F8
         Caption         =   "DayBook.frx":0910
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "DayBook.frx":097C
         Keys            =   "DayBook.frx":099A
         Spin            =   "DayBook.frx":09F8
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
      ...
      Begin TDBDate6Ctl.TDBDate MhDateInput2 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "DayBook.frx":0A20
         Caption         =   "DayBook.frx":0B38
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "DayBook.frx":0BA4
         Keys            =   "DayBook.frx":0BC2
         Spin            =   "DayBook.frx":0C20
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
...
Private Sub Form_Load()
    ...
    'Comma Separated List of Accounts in Easy Publish
    rstAccountList.Open "SELECT Alias FROM AccountMaster WHERE Alias NOT IN ('','0')", cnDatabase, adOpenKeyset, adLockReadOnly
    ...
    CxnDayBook.Open "Provider=SQLOLEDB.1;Password=" & ServerPassword & ";Persist Security Info=True;User ID=" & ServerUser & ";Initial Catalog=" & DatabaseName & ";Data Source=" & ServerName
...
Private Sub PrintDayBook()
    ...
    If LYDataExist Then
        rstDayBook.Open "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'BP/" & Right(Year(FinancialYearFrom), 2) & "-" & Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild05 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.BookPrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'BP/" & Right(Year(FinancialYearFrom) - 1, 2) & "-" & Right(Year(FinancialYearTo) - 1, 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (OBookPOChild05 C INNER JOIN OBookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.BookPrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'TP/" & Right(Year(FinancialYearFrom), 2) & "-" & Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild06 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.TitlePrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'TP/" & Right(Year(FinancialYearFrom) - 1, 2) & "-" & Right(Year(FinancialYearTo) - 1, 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (OBookPOChild06 C INNER JOIN OBookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.TitlePrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'TL/" & Right(Year(FinancialYearFrom), 2) & "-" & Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild07 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.Laminator=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'TL/" & Right(Year(FinancialYearFrom) - 1, 2) & "-" & Right(Year(FinancialYearTo) - 1, 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (OBookPOChild07 C INNER JOIN OBookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.Laminator=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'BB/" & Right(Year(FinancialYearFrom), 2) + "-" + Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild08 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.Binder=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'BB/" & Right(Year(FinancialYearFrom) - 1, 2) + "-" + Right(Year(FinancialYearTo) - 1, 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (OBookPOChild08 C INNER JOIN OBookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.Binder=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,IIF(OrderType='1','PB/','PT/')+'" & Right(Year(FinancialYearFrom), 2) + "-" + Right(Year(FinancialYearTo), 2) & "/'+Trim(T.Name) As OrderNo,T.BillNo,T.BillDate,T.PaidAmount,T.Adjustment,T.AdjustmentRemarks,T.ComputerName,M.Alias FROM PaperPOParent T INNER JOIN AccountMaster M ON T.Supplier=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'MI/" & Right(Year(FinancialYearFrom), 2) + "-" + Right(Year(FinancialYearTo), 2) & "/'+Trim(T.Name) As OrderNo,T.BillNo,T.BillDate,T.PaidAmount,T.Adjustment,T.AdjustmentRemarks,T.ComputerName,M.Alias FROM OutsourceItemPOParent T INNER JOIN AccountMaster M ON T.Supplier=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ")", cnDatabase, adOpenKeyset, adLockOptimistic
    Else
        rstDayBook.Open "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'BP/" & Right(Year(FinancialYearFrom), 2) & "-" & Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild05 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.BookPrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
                        "UNION " & _
                        "SELECT M.Name As EasyPublishAccount,M.Name As BusyAccount,'TP/" & Right(Year(FinancialYearFrom), 2) & "-" & Right(Year(FinancialYearTo), 2) & "/'+Trim(P.Name) As OrderNo,C.BillNo,C.BillDate,C.PaidAmount,C.Adjustment,C.AdjustmentRemarks,C.ComputerName,M.Alias FROM (BookPOChild06 C INNER JOIN BookPOParent P ON P.Code=C.Code) INNER JOIN AccountMaster M ON P.TitlePrinter=M.Code WHERE BillFeedDate>=#" & GetDate(MhDateInput1.Text) & " 00:00:00# AND BillFeedDate<=#" & GetDate(MhDateInput2.Text) & " 23:59:59# AND M.Alias IN (" & SelectedItems(lvwAccount) & ") " & _
