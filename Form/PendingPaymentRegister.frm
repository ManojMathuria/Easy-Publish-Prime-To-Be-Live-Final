...
Begin VB.Form FrmPendingPaymentRegister 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PendingPaymentRegister.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PendingPaymentRegister.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "PendingPaymentRegister.frx":0658
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "PendingPaymentRegister.frx":076C
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "PendingPaymentRegister.frx":0788
         Picture         =   "PendingPaymentRegister.frx":07A4
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "PendingPaymentRegister.frx":07C0
         Picture         =   "PendingPaymentRegister.frx":07DC
      End
      Begin TDBDate6Ctl.TDBDate MhDateInput2 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "PendingPaymentRegister.frx":07F8
         Caption         =   "PendingPaymentRegister.frx":0910
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "PendingPaymentRegister.frx":097C
         Keys            =   "PendingPaymentRegister.frx":099A
         Spin            =   "PendingPaymentRegister.frx":09F8
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
      ...
      Begin TDBDate6Ctl.TDBDate MhDateInput1 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "PendingPaymentRegister.frx":0A20
         Caption         =   "PendingPaymentRegister.frx":0B38
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "PendingPaymentRegister.frx":0BA4
         Keys            =   "PendingPaymentRegister.frx":0BC2
         Spin            =   "PendingPaymentRegister.frx":0C20
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
...
Private Sub Form_Load()
    ...
    CxnPendingPayment.Open "Provider=SQLOLEDB.1;Password=" & ServerPassword & ";Persist Security Info=True;User ID=" & ServerUser & ";Initial Catalog=" & DatabaseName & ";Data Source=" & ServerName
    Call LoadPartyList
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    If Button.Index = 1 Then
        OutputTo = "S": PrintPendingPayment
    ElseIf Button.Index = 2 Then
        OutputTo = "P": PrintPendingPayment
...
Private Sub PrintPendingPayment()
    ...
    rstPendingPayment.Open "SELECT Name As Account,Alias,(SELECT Name FROM Master1 WHERE Code=M.ParentGrp) As AccountGroup," & _
                           ...
                           "(SELECT  ISNULL(SUM(Value1),0) FROM Tran2 WHERE RecType=1 AND MasterCode1=M.Code AND Date>='" & GetDate(MhDateInput1.Text) & "' AND Date<='" & GetDate(MhDateInput2.Text) & "') As CurBal," & _
    ...
    rstUnbilledPayment.Open "SELECT Alias,SUM(BillAmount) As Amount FROM (PaperPOParent P INNER JOIN PaperPOChild C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Supplier WHERE  P.Date>=#" & GetDate(MhDateInput1.Text) & "# AND P.Date<=#" & GetDate(MhDateInput2.Text) & "# AND P.BillNo='' GROUP BY Alias " & _
                            ...
                            "UNION ALL " & _
                            "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild05 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.BookPrinter WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND P.Date>=#" & GetDate(MhDateInput1.Text) & "# AND P.Date<=#" & GetDate(MhDateInput2.Text) & "# AND C.BillNo='' GROUP BY Alias " & _
                            "UNION ALL " & _
                            "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild06 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.TitlePrinter WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND P.Date>=#" & GetDate(MhDateInput1.Text) & "# AND P.Date<=#" & GetDate(MhDateInput2.Text) & "# AND C.BillNo='' GROUP BY Alias " & _
                            "UNION ALL " & _
                            "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild07 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Laminator WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND P.Date>=#" & GetDate(MhDateInput1.Text) & "# AND P.Date<=#" & GetDate(MhDateInput2.Text) & "# AND C.BillNo='' GROUP BY Alias " & _
                            "UNION ALL " & _
                            "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild08 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Binder WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND P.Date>=#" & GetDate(MhDateInput1.Text) & "# AND P.Date<=#" & GetDate(MhDateInput2.Text) & "# AND C.BillNo='' GROUP BY Alias " & _
                            "ORDER BY Alias", cnDatabase, adOpenKeyset, adLockReadOnly
    ...
    If rstCompanyMaster.Fields("CreatedFrom").Value <> "" Then
        ...
        rstImporter.Open "SELECT Alias,SUM(BillAmount) As Amount FROM (PaperPOParent P INNER JOIN PaperPOChild C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Supplier WHERE P.BillNo='' GROUP BY Alias " & _
                         ...
                         "UNION ALL " & _
                         "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild05 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.BookPrinter WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND C.BillNo='' GROUP BY Alias " & _
                         "UNION ALL " & _
                         "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild06 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.TitlePrinter WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND C.BillNo='' GROUP BY Alias " & _
                         "UNION ALL " & _
                         "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild07 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Laminator WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND C.BillNo='' GROUP BY Alias " & _
                         "UNION ALL " & _
                         "SELECT Alias,SUM(BillAmount) As Amount FROM (BookPOParent P INNER JOIN BookPOChild08 C ON P.Code=C.Code) INNER JOIN AccountMaster M ON M.Code=P.Binder WHERE  LEFT(P.Type,1)<>'O' AND LEFT(P.Code,1)<>'*' AND C.BillNo='' GROUP BY Alias " & _
...
Private Sub LoadPartyList()
    Dim SQL As String
    SQL = "WITH RCTE AS (SELECT Code FROM Master1 WHERE MasterType=1 AND Name LIKE '%Sundry Creditor%' UNION ALL SELECT P.Code FROM Master1 P INNER JOIN RCTE C ON P.ParentGrp=C.Code WHERE MasterType=1)" & _
          "SELECT Name,Code FROM Master1 WHERE MasterType=2 AND ParentGrp IN (SELECT Code FROM RCTE) ORDER BY Name"
    If rstAccountList.State = adStateOpen Then rstAccountList.Close
    rstAccountList.Open SQL, CxnPendingPayment, adOpenKeyset, adLockReadOnly
