...
Begin VB.Form FrmInsourceItemSupplierRegister 
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "InsourceItemSupplierRegister.frx":0000
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "InsourceItemSupplierRegister.frx":0544
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "InsourceItemSupplierRegister.frx":0658
            Key             =   ""
         EndProperty
      EndProperty
   End
   Begin Mh3dfrmLibCtl.Mh3dFrame Mh3dFrame1 
      ...
      FormatString    =   ""
      Caption         =   ""
      Picture         =   "InsourceItemSupplierRegister.frx":076C
      ...
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "InsourceItemSupplierRegister.frx":0788
         Picture         =   "InsourceItemSupplierRegister.frx":07A4
      End
      Begin Mh3dlblLib.Mh3dLabel Mh3dLabel2 
         ...
         FillColor       =   9164542
         TextColor       =   0
         Picture         =   "InsourceItemSupplierRegister.frx":07C0
         Picture         =   "InsourceItemSupplierRegister.frx":07DC
      End
      ...
      Begin TDBDate6Ctl.TDBDate MhDateInput2 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "InsourceItemSupplierRegister.frx":07F8
         Caption         =   "InsourceItemSupplierRegister.frx":0910
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "InsourceItemSupplierRegister.frx":097C
         Keys            =   "InsourceItemSupplierRegister.frx":099A
         Spin            =   "InsourceItemSupplierRegister.frx":09F8
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
      ...
      Begin TDBDate6Ctl.TDBDate MhDateInput1 
         ...
         _ExtentX        =   1931
         _ExtentY        =   582
         Calendar        =   "InsourceItemSupplierRegister.frx":0A20
         Caption         =   "InsourceItemSupplierRegister.frx":0B38
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            Name            =   "Calibri"
            Size            =   9.75
            Charset         =   0
            ...
            Strikethrough   =   0   'False
         EndProperty
         DropDown        =   "InsourceItemSupplierRegister.frx":0BA4
         Keys            =   "InsourceItemSupplierRegister.frx":0BC2
         Spin            =   "InsourceItemSupplierRegister.frx":0C20
         AlignHorizontal =   0
         AlignVertical   =   0
         Appearance      =   0
         BackColor       =   16777215
...
Private Sub BookSelection(ByVal SelectAll As Boolean)
    If rstBookList.State = adStateOpen Then
        rstBookList.Close
    End If
    rstBookList.Open "Select Name, Code From BookMaster Where " & IIf(SelectAll, IIf(ItemType = "3", "Board='000000'", IIf(ItemType = "4", "Type='R' And Board<>'000000'", "Board<>'000000' AND Type='F'")), "Board In (" & SelectedItems(ListView1) & ")") & " Order by Name", cnDatabase, adOpenKeyset, adLockReadOnly
...
Private Sub PrintInsourceItemSupplierRegister()
    ...
    If ItemType <> "5" Then
        rstInsourceItemSupplierRegister.Open "Select 'Printer Name : '+Trim(M1.PrintName) As PrinterName,'Item Name : '+Trim(M2.PrintName) As InsourceItemName,'' As GodownName,Trim(P.Name) As VchNo,'' As OrderNo,P.Date As VchDate,'PO' As VchType,ActualQuantity As FinalQuantity From AccountMaster M1,BookMaster M2,BookPOParent P,BookPOChild05 C Where M2.Code=P.Book And P.Code=C.Code And LEFT(P.Type,1)<>'O' And Left(P.Code,1)<>'*' And P.BookPrinter=M1.Code And M2.Code In (" & SelectedInsourceItems & ")  And M2.Board In (" & SelectedBoards & ") And M1.Code In (" & SelectedPrinters & ") And P.Date>=#" & GetDate(MhDateInput1.Text) & "# And P.Date<=#" & GetDate(MhDateInput2.Text) & "# UNION " & _
                                                                       ...
                                                                       "From AccountMaster M1,BookMaster M2,MaterialIOParent P,MaterialIOChild C,BookPOParent R Where M2.Code=C.Item And C.Category='" & ItemType & "' AND P.Code=C.Code And C.Ref=R.Code And P.Source=M1.Code And M2.Code In (" & SelectedInsourceItems & ")  And M2.Board In (" & SelectedBoards & ") And M1.Code In (" & SelectedPrinters & ")  And P.Date>=#" & GetDate(MhDateInput1.Text) & "# And P.Date<=#" & GetDate(MhDateInput2.Text) & "# Order By PrinterName,InsourceItemName,VchNo,OrderNo", cnDatabase, adOpenKeyset, adLockOptimistic
    Else
        rstInsourceItemSupplierRegister.Open "Select 'Printer Name : '+Trim(M1.PrintName) As PrinterName,'Item Name : '+Trim(M2.PrintName) As InsourceItemName,'' As GodownName,Trim(P.Name) As VchNo,'' As OrderNo,P.Date As VchDate,'PO' As VchType,ActualQuantity-(SELECT IIF(ISNULL(SUM(ActualQuantity)),0,SUM(ActualQuantity)) FROM BookPOChild08 WHERE Code=P.Code) As FinalQuantity From AccountMaster M1,BookMaster M2,BookPOParent P,BookPOChild07 C Where M2.Code=P.Book And P.Code=C.Code And LEFT(P.Type,1)<>'O' And Left(P.Code,1)<>'*' And P.Laminator=M1.Code And M2.Code In (" & SelectedInsourceItems & ")  And M2.Board In (" & SelectedBoards & ") And IIF(P.Type='F',QuantityToOffice > 0,'1') And M1.Code In (" & SelectedPrinters & ") And P.Date>=#" & GetDate(MhDateInput1.Text) & "# And P.Date<=#" & GetDate(MhDateInput2.Text) & "# UNION " & _
                                                                       "Select 'Printer Name : '+Trim(M1.PrintName) As PrinterName,'Item Name : '+Trim(M2.PrintName) As InsourceItemName,(Select Trim(PrintName) From AccountMaster Where Code=C.Godown) As GodownName,Trim(R.Name) As VchNo,Trim(P.Name) As OrderNo,P.Date As VchDate,'PS' As VchType,Quantity As FinalQuantity " & _
                                                                       "From AccountMaster M1,BookMaster M2,MaterialIOParent P,MaterialIOChild C,BookPOParent R Where M2.Code=C.Item And C.Category='" & ItemType & "' AND P.Code=C.Code And C.Ref=R.Code And P.Source=M1.Code And M2.Code In (" & SelectedInsourceItems & ")  And M2.Board In (" & SelectedBoards & ") And M1.Code In (" & SelectedPrinters & ")  And P.Date>=#" & GetDate(MhDateInput1.Text) & "# And P.Date<=#" & GetDate(MhDateInput2.Text) & "# Order By PrinterName,InsourceItemName,VchNo,OrderNo", cnDatabase, adOpenKeyset, adLockOptimistic
    End If
    ...
    Else
        rptInsourceItemSupplierRegister.PaperSource = crPRBinAuto
