...
Begin VB.Form FrmSelectionList 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "SelectionList.frx":0000
      Height          =   4210
      Left            =   45
      TabIndex        =   2
      TabStop         =   0   'False
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SelectionList.frx":0015
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "SelectionList.frx":0559
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin Mh3dlblLib.Mh3dLabel Mh3dLabel1 
      ...
      Alignment       =   0
      FillColor       =   9164542
      Picture         =   "SelectionList.frx":06B5
      Picture         =   "SelectionList.frx":06D1
   End
End
...
Private Sub Form_Activate()
    ...
    If Not CheckEmpty(txtName, False) Then
        ...
        If SearchOrder <> 0 Then Text1.Text = "": PrevStr = ""
    End If
    If SearchOrder <> 0 Then rstSelectionList.Sort = "Col0 Asc": FindFieldName = "Col0"
    If txtName.Text <> "" And dblBookMark <> 0 Then rstSelectionList.Bookmark = dblBookMark
...
With rstSelectionList
        ...
        If Not CheckEmpty(Text1.Text, False) Then
            .Filter = "[Col0] Like '%" & FixQuote(Text1.Text) & "%'"
            If .EOF Then
            .Filter = adFilterNone
                .MoveFirst
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    ElseIf Button.Index = 2 Then
        ...
        rstSelectionList.ActiveConnection = cnDatabase
