...
'Common Update
    ...
    cnDatabase.Execute "CREATE TABLE dbo.Tmp_TeamMemberMaster(Code nvarchar(6) NOT NULL,Name nvarchar(40) NOT NULL,PrintName nvarchar(40) NOT NULL,Department nvarchar(6) NOT NULL,Designation nvarchar(6) NOT NULL,LoginId nvarchar(6) NOT NULL,ReportingTo nvarchar(6) NULL,eMail nvarchar(50) NULL,CreatedBy nvarchar(6) NOT NULL,CreatedOn datetime NOT NULL,ModifiedBy nvarchar(6) NULL,ModifiedOn datetime NULL,Recordstatus nvarchar(1) NOT NULL,Printstatus nvarchar(1) NOT NULL)  ON [PRIMARY]"
    cnDatabase.Execute "ALTER TABLE dbo.Tmp_TeamMemberMaster SET (LOCK_ESCALATION = TABLE)"
    ...
    cnDatabase.Execute "DROP TABLE dbo.TeamMemberMaster"
    cnDatabase.Execute "EXECUTE sp_rename N'dbo.Tmp_TeamMemberMaster', N'TeamMemberMaster', 'OBJECT' "
    '***************************************************************************************************************************************************************
NXT:
    cnDatabase.CommitTrans
