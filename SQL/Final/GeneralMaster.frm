...
Private Sub Form_Load()
    ...
    If MasterType = "1" Then 'Size Master
        Mh3dLabel2.Caption = " Group (s)": MhRealInput1.Visible = False
    ElseIf MasterType = "5" Or MasterType = "12" Then 'Item/Account Group Master
        Mh3dLabel2.Caption = " Under Group ": MhRealInput1.Visible = False: Text4.Locked = False
    ElseIf MasterType = "15" Or MasterType = "20" Then  'Paper Unit/Calc Mode Master
        Mh3dLabel2.Caption = IIf(MasterType = "15", " Sheets/Unit", " Value (0 if varies)"): Text4.Visible = False
    ElseIf MasterType = "23" Then 'Color Master
        Mh3dLabel2.Caption = " Color": Text4.Visible = False
    Else
        Mh3dLabel2.Visible = False: Mh3dFrame2.Height = 860: Text4.Visible = False: MhRealInput1.Visible = False
    ...
    With rstGeneralMaster
        ...
        If MasterType = "1" Then    'Size Master
            With rstchkRef
                ...
                .Open "SELECT STUFF((SELECT ', '+(LTRIM(M.Name)) FROM SizeGroupChild C INNER JOIN GeneralMaster M ON C.Code=M.Code WHERE [Size]='" & .Fields("Code").Value & "' ORDER BY M.Name FOR XML PATH('')),1,1,'') As Name", cnDatabase, adOpenKeyset, adLockReadOnly
...
Private Sub SaveFields()
    With rstGeneralMaster
        ...
        .Fields("Value1").Value = MhRealInput1.Value
    ...
    If KeyCode = vbKeySpace Or KeyCode = vbKeyDown Or KeyCode = 144 Then
        ...
        With fpSpread1
            ...
            Do Until rstAccountGroup.EOF
                ...
                .SetText 2, i, rstAccountGroup.Fields("UGroup").Value
